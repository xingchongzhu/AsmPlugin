package com.data.asm

import com.data.bean.AutoClassFilter
import com.data.bean.LogMethodCell
import com.data.util.Logger
import com.data.util.AutoMatchUtil
import com.data.LogHookConfig
import com.data.util.LogAnalyticsUtil
import com.data.GlobalConfig
...
//            Logger.info("visitedFragMethods:" + visitedFragMethods)
            while (iterator.hasNext()) {
                ...
                mv.visitEnd()
                mv.visitAnnotation(Constants.AUTODATAINSTRUMENTED, false)
            }
        }
